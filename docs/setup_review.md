...
Create an exact-source, standalone HTML chart for a chart-review setup:
...
and draws the detector's liquidity/swing level, raid extreme, structure-shift
level, FVG/CE, frozen invalidation, and lifecycle timestamps.
